...
function game() {
    // game ends with end in console so undefined doesn't show up
    game = "end"
    ...
    for (let i = 0; i < 4; i++) {
        ...
        if (questionSix == anw6) {
            ...
            //ends question if the user gets it right breaks loop
            break;
        } else if (questionSix > 4) {
            alert("Your guess was " + questionSix + ". That's too high. Try Again!");
        } else if (questionSix < 4) {
...
game()
// makes it so function doesn't end in undefined 
game